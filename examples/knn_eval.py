...
def main():
	...
	if args.mini:
            ...
            met_db_info_file = "code/mini_MET_database.json"
	else:
        #met_db_info_file = args.info_dir + "/MET_database.json"
		met_db_info_file = "code/MET_database.json"
	testset_info_file = "code/testset.json"
	valset_info_file = "code/valset.json"
